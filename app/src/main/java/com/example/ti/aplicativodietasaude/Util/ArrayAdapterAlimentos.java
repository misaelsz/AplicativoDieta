...
public class ArrayAdapterAlimentos extends ArrayAdapter<Alimento> {
    ...
    public View getView(int position, @Nullable View convertView, @NonNull ViewGroup parent){
        ...
        txtNomeAlimento = (TextView) convertView.findViewById(R.id.nomeAlimento);
        txtCalorias = (TextView) convertView.findViewById(R.id.calorias);

        txtNomeAlimento.setText(alimento.get);
    }
}
